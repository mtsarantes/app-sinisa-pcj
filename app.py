import pandas as pd
from flask import Flask, jsonify, render_template  # Importa 'render_template'
from flask_cors import CORS
import numpy as np

# A inicialização do Flask agora é mais simples
app = Flask(__name__)
CORS(app) 
...
@app.route('/')
def index():
    # Esta função agora usa 'render_template' para encontrar o ficheiro na pasta 'templates'
